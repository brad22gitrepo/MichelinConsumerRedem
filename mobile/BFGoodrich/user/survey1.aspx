<%@ page title="" language="VB" masterpagefile="~/mobile/bfg.mobile.master" autoeventwireup="false" inherits="mobile_BFGoodrich_user_survey1, App_Web_survey1.aspx.6fd4c3ae" %>
    ...
    <div style="background-color: #ecf5fa; width: 100%;">
        ...
        <table border="0" cellpadding="2" cellspacing="0" style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    <center>
                        <asp:DropDownList ID="ddlAge" runat="server" CssClass="baseControl requiredCSS" Width="234px"
                            onchange="JavaScript:DropDownList_WaterMark_Change(this);">
                            <asp:ListItem Text="" Value="-1"></asp:ListItem>
                        </asp:DropDownList>
                    </center>
                </td>
