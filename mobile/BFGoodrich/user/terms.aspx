<%@ page title="" language="VB" masterpagefile="~/mobile/bfg.mobile.master" autoeventwireup="false" inherits="mobile_BFGoodrich_user_terms, App_Web_terms.aspx.6fd4c3ae" %>
    ...
    <div style="background-color: #ecf5fa; width: 100%;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="height: 29px; width: 100%;">
            <tr>
                ...
                <td class="breadCrumbContent1" style="background-image: url(/images/mobile/breadCrumbInActiveMid.png);
                ...
                <td class="breadCrumbContent2" style="background-image: url(/images/mobile/breadCrumbInActiveMid.png);
                    background-repeat: repeat-x;">
                    Vehicle Info
                </td>
                ...
                <td class="breadCrumbContent3" style="background-image: url(/images/mobile/breadCrumbActiveBFGMid.png);
        ...
        <table border="0" cellpadding="2" cellspacing="0" style="width: 100%;">
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="lblInternetText" runat="server" BorderColor="LightGray" BorderStyle="Solid" BorderWidth="1" CssClass="baseControl" Text="" />
                </td>
                <td style="width: 10px;">
                    &nbsp;
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:CheckBox ID="ck_Accept" runat="server" AutoPostBack="true" CssClass="baseControl" Text="I accept these terms & conditions" OnCheckedChanged="ck_Accept_CheckedChanged" />
                </td>
                <td style="width: 10px;">
                    &nbsp;
                </td>
                ...
                <td style="text-align: right;">
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            ...
                            <asp:Button ID="btnSubmit" runat="server" CssClass="michbtndisabledbg roundedCorners" Enabled="false"
                                Font-Bold="true" Text="Submit" Width="80px" OnClick="btnSubmit_Click" />
                        </ContentTemplate>
                        <Triggers>
