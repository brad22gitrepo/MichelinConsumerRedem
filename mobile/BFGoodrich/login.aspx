<%@ page title="" language="VB" masterpagefile="~/mobile/bfg.mobile.master" autoeventwireup="false" inherits="mobile_BFGoodrich_login, App_Web_login.aspx.2ad8fc7a" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table border="0" cellpadding="2" cellspacing="0" style="background-color: #ecf5fa;
        ...
        <tr>
            ...
            <td>
                <center>
                    <asp:Panel ID="pnlPassword" runat="server" DefaultButton="btnLogin" Width="100%">
