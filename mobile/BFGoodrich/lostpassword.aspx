<%@ page title="" language="VB" masterpagefile="~/mobile/bfg.mobile.master" autoeventwireup="false" inherits="mobile_BFGoodrich_lostpassword, App_Web_lostpassword.aspx.2ad8fc7a" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <asp:PasswordRecovery ID="PasswordRecovery1" runat="server" Width="100%">
                ...
                <SuccessTemplate>
                    <table border="0" cellpadding="2" cellspacing="0" style="background-color: #ecf5fa;
                        ...
                        <tr>
                            <td>
                                click
                                <asp:HyperLink ID="HyperLink1" ForeColor="#0169b2" NavigateUrl="/mobile/bfgoodrich/login.aspx"
                ...
                <MailDefinition IsBodyHtml="true" BodyFileName="~/BFGoodrich/Email/ResetPassword.htm"
                    From="contact@TireRewardCenter.com" Subject="BFGoodrich Fulfillment Center - Password Information">
                </MailDefinition>
