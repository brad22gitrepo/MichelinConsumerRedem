<%@ page title="" language="VB" masterpagefile="~/mobile/michelin.mobile.master" autoeventwireup="false" inherits="mobile_Michelin_user_step3, App_Web_step3.aspx.a3a7420f" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="background-color: #ecf5fa; width: 100%;">
        ...
        <table border="0" cellpadding="2" cellspacing="0" style="border-bottom: solid 1px LightGrey;
            width: 100%;">
            <tr>
                <td style="width: 10px;">
                    &nbsp;
