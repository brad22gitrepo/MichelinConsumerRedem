<%@ page title="" language="VB" masterpagefile="~/mobile/michelin.mobile.master" autoeventwireup="false" inherits="mobile_Michelin_rewardstatus, App_Web_rewardstatus.aspx.a3a7420f" %>
        ...
        <tr>
            <td id="tdNewRedemption" class="logobg" style="vertical-align: top;" onclick="JavaScript:document.getElementById('<%= lbtnNewRedemption.ClientID %>').click();"
                ...
                <asp:LinkButton ID="lbtnNewRedemption" runat="server" CssClass="baseControl controlHeight"
                    Font-Bold="true" Font-Size="11pt" Font-Underline="false" ForeColor="Black" Width="100%"
                    OnClick="lbtnNewRedemption_Click">
                ...
                <cc1:Accordion ID="accRedemptions" runat="server" BorderWidth="0" SelectedIndex="-1"
                    ...
                    <Panes>
                        <cc1:AccordionPane ID="AccordionPane1" runat="server" CssClass="logobg" BorderWidth="0"
                            ...
                            <Content>
                                <table border="0" cellpadding="0" cellspacing="0" style="background-color: #00445b;
                                    width: 100%;">
                                    <tr>
                                        <td>
                                                        ...
                                                        <Columns>
                                                            <asp:TemplateField>
                                                                ...
                                                                <ItemTemplate>
                                                                    <table border="0" cellpadding="2" cellspacing="0" style="width: 100%;">
                                                                        <tr>
                                                                            <td class="tabletColumn" style="border: solid 1px #0169b2; color: White;">
                                                                            ...
                                                                            <td class="tabletColumn" style="border: solid 1px #0169b2; color: White; width: 240px;">
                                                                                <asp:Label ID="Label2" runat="server" CssClass="baseControl" Text='<%# Eval("Reward")%>'></asp:Label>
                                                                            </td>
                                                                            <td class="tabletColumn" style="border: solid 1px #0169b2; color: White; width: 80px;">
                                                                                <asp:Label ID="Label3" runat="server" CssClass="baseControl" Text='<%# FormatDate(Eval("PurchaseDate"))%>'></asp:Label>
                                                                            </td>
                                                                            <td class="tabletColumn" style="border: solid 1px #0169b2; color: White; width: 100px;">
                                                                                <center>
                                                                            ...
                                                                            <td class="tabletColumn" style="border: solid 1px #0169b2; color: White; width: 70px;">
                                                                                <asp:Label ID="Label4" runat="server" CssClass="baseControl" Text='<%# Eval("Status")%>'></asp:Label>
                                                                            </td>
                                                                            <td class="mobileColumn" style="border: solid 1px #0169b2; color: White;">
                                                                            ...
                                                                            <td class="mobileColumn" style="border: solid 1px #0169b2; color: White; width: 70px;">
                                                                                <asp:Label ID="lblStatus" runat="server" CssClass="baseControl" Text='<%# Eval("Status")%>'></asp:Label>
                                                                            </td>
                                                                            <td class="mobileColumn" style="border: solid 1px #0169b2; color: White; width: 80px;">
        ...
        <tr>
            <td class="logobg" style="padding-top: none; vertical-align: top;" onclick="JavaScript:document.getElementById('<%= lbtnActivate.ClientID %>').click();"
                ...
                <asp:LinkButton ID="lbtnActivate" runat="server" CssClass="baseControl controlHeight"
                    Font-Bold="false" Font-Size="8pt" Font-Underline="false" ForeColor="Black" OnClick="lbtnActivate_Click">
                    <div style="padding: 10px 10px 10px 10px;">
