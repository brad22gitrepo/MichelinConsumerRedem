<%@ page title="" language="VB" masterpagefile="~/mobile/michelin.mobile.master" autoeventwireup="false" inherits="mobile_Michelin_user_faq, App_Web_faq.aspx.1bad1d5f" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="background-color: #ecf5fa; width: 100%;">
        ...
        <table border="0" cellpadding="10" cellspacing="0" style="width: 100%;">
            <tr>
                <td>
                    <b style="color: Black; font-size: 13pt;">Frequently Asked Questions</b>
                </td>
            </tr>
        </table>
        <cc1:Accordion ID="accRedemptions" runat="server" BorderWidth="0" SelectedIndex="-1"
            ...
            <Panes>
                            ...
                            <table border="0" cellpadding="10" cellspacing="0" style="width: 100%;">
                                <tr>
                                    <td class="logobg" style="color: Black; height: 32px;">
                                        How do I submit a redemption for my recent MICHELIN<sup>®</sup> tire purchase?
                                    </td>
                        ...
                        <table border="0" cellpadding="10" cellspacing="0" style="background-color: #00445b;
                            ...
                            <tr>
                                <td>
                                    ...
                                    <a href='/mobile/michelin/login.aspx'>online</a> after purchasing four new MICHELIN<sup>®</sup>
                                    brand passenger or light truck tires. For regular service, complete and mail in
                                    the redemption form given to you from a participating <a href='http://www.michelinman.com/dealer-locator/dealer-locator.page'
                                        target='_blank'>dealer</a>. During the promotional timeframe, eligible dealers
                                    will be displayed with a $70 icon on <a href='http://www.michelinman.com' target="_blank">
                                        www.michelinman.com</a>. A valid receipt showing the purchase of four new MICHELIN<sup>®</sup>
                                    brand passenger or light truck tires within the offer period is required to process
                                    your reward.
                                </td>
                            </tr>
                        </table>
                ...
                <cc1:AccordionPane ID="AccordionPane2" runat="server" CssClass="logobg" BorderWidth="0"
                    ...
                    <Content>
                        <table border="0" cellpadding="10" cellspacing="0" style="background-color: #00445b;
                            ...
                            <tr>
                                <td>
                                    To receive your $70 MasterCard<sup>®</sup> Reward Card, purchase four new MICHELIN<sup>®</sup>
                                    brand passenger or light truck tires from a participating dealer within the promotional
                                    timeframe. Promotion dates change throughout the year so please visit <a href='http://www.michelinman.com/promotions.page'
                                        target='_blank'>http://www.michelinman.com/promotions.page</a> to learn more.
                                    If you’ve already purchased the tires you must submit your redemption within 30
                                    days after the promotion ended in order to take advantage of the offer.
                                </td>
                            </tr>
                        </table>
                    </Content>
                ...
                <cc1:AccordionPane ID="AccordionPane3" runat="server" CssClass="logobg" BorderWidth="0"
                    ...
                    <Content>
                        <table border="0" cellpadding="10" cellspacing="0" style="background-color: #00445b;
                            ...
                            <tr>
                                <td>
                                    You can view the status of your $70 Reward Card request here at the Michelin Reward
                                    Center. <a href="/mobile/michelin/login.aspx">Log in</a> if you’ve previously submitted a redemption
                                    online. If you mailed in your redemption form, simply give us a little information
                                    about yourself and we’ll provide the <a href='/michelin/MailInLookup.aspx'>status</a> of your
                                    $70 Reward Card request.
                                </td>
                            </tr>
                        </table>
                    </Content>
                        ...
                        <table border="0" cellpadding="10" cellspacing="0" style="background-color: #00445b;
                            ...
                            <tr>
                                <td>
                                    ...
                                    reward. You can view the current status of your Reward Card request on the <a href='/michelin/MichHome.aspx'>
                                        Michelin Fullfillment Center</a>.
                                </td>
                            </tr>
                        </table>
                    </Content>
                        ...
                        <table border="0" cellpadding="10" cellspacing="0" style="background-color: #00445b;
                            ...
                            <tr>
                                <td>
                                    ...
                                    can view the current status of your Reward Card request on the <a href='/michelin/MichHome.aspx'>
                                        Michelin Fullfillment Center</a>.
                                </td>
                            </tr>
                        </table>
                ...
                <cc1:AccordionPane ID="AccordionPane6" runat="server" CssClass="logobg" BorderWidth="0"
                    ...
                    <Content>
                        <table border="0" cellpadding="10" cellspacing="0" style="background-color: #00445b;
                            ...
                            <tr>
                                <td>
                                    We apologize, but late redemptions will not be honored. Please visit <a href='http://www.michelinman.com/promotions.page'
                                        target='_blank'>Michelin Promotions</a> page to learn more about future
                                    offers.
                                </td>
                            </tr>
                        </table>
                ...
                <cc1:AccordionPane ID="AccordionPane7" runat="server" CssClass="logobg" BorderWidth="0"
                    ...
                    <Content>
                        <table border="0" cellpadding="10" cellspacing="0" style="background-color: #00445b;
                            ...
                            <tr>
                                <td>
                                    Contact the support team by calling 1-866-212-9619 Monday through Friday from 8:00
                ...
                <cc1:AccordionPane ID="AccordionPane22" runat="server" CssClass="logobg" BorderWidth="0"
                    BorderStyle="None">
                    <Header>
                        <a href="" onclick="JavaScript:ShowSelection('<%= ibtnPane6.ClientID %>');" style="text-decoration: none;">
                            <table border="0" cellpadding="10" cellspacing="0" style="width: 100%;">
                                <tr>
                                    ...
                                    <td class="logobg" style="width: 40px; height: 32px;">
                                        <asp:ImageButton ID="ImageButton16" runat="server" ImageUrl="/images/mobile/rightarrow.png" />
                                    </td>
                                </tr>
                            </table>
                        </a>
                            ...
                            <tr>
                                <td>
                                    Yes, the certificate includes a rebate valid for purchase of four new MICHELIN<sup>®</sup> , BFGoodrich<sup>®</sup> , 
                                            ...
                                            Reward Card for Uniroyal purchases. 
                                </td>
                            </tr>
                        </table>
                    </Content>
                </cc1:AccordionPane>
                <cc1:AccordionPane ID="AccordionPane23" runat="server" CssClass="logobg" BorderWidth="0"
                    BorderStyle="None">
                    <Header>
                        <a href="" onclick="JavaScript:ShowSelection('<%= ibtnPane6.ClientID %>');" style="text-decoration: none;">
                            <table border="0" cellpadding="10" cellspacing="0" style="width: 100%;">
                                <tr>
                                    ...
                                    <td class="logobg" style="width: 40px; height: 32px;">
                                        <asp:ImageButton ID="ImageButton17" runat="server" ImageUrl="/images/mobile/rightarrow.png" />
                                    </td>
                                </tr>
                            </table>
                        </a>
                            ...
                            <tr>
                                <td>
                                    Yes, all leagues should be available when redeeming online. In the event your league does not display, 
                                            please contact-1-866-212-9619 and a customer service representative will assist you. 
                                </td>
                            </tr>
                        </table>
                    </Content>
                </cc1:AccordionPane>
                <cc1:AccordionPane ID="AccordionPane24" runat="server" CssClass="logobg" BorderWidth="0"
                    BorderStyle="None">
                    <Header>
                        <a href="" onclick="JavaScript:ShowSelection('<%= ibtnPane6.ClientID %>');" style="text-decoration: none;">
                            <table border="0" cellpadding="10" cellspacing="0" style="width: 100%;">
                                <tr>
                                    ...
                                    <td class="logobg" style="width: 40px; height: 32px;">
                                        <asp:ImageButton ID="ImageButton18" runat="server" ImageUrl="/images/mobile/rightarrow.png" />
                                    </td>
                                </tr>
                            </table>
                        </a>
                    ...
                    <Content>
                        <table border="0" cellpadding="10" cellspacing="0" style="background-color: #00445b;
                            ...
                            <tr>
                                <td>
                                    Visit <a href='http://www.michelinsoccer.com' target='_blank'>www.michelinsoccer.com</a> or contact the soccer hotline at 1-877-894-3314 for program details.
                                </td>
                            </tr>
                        </table>
                    </Content>
                </cc1:AccordionPane>
                <cc1:AccordionPane ID="AccordionPane25" runat="server" CssClass="logobg" BorderWidth="0"
                    BorderStyle="None">
                    <Header>
                        <a href="" onclick="JavaScript:ShowSelection('<%= ibtnPane6.ClientID %>');" style="text-decoration: none;">
                            <table border="0" cellpadding="10" cellspacing="0" style="width: 100%;">
                                <tr>
                                    ...
                                    <td class="logobg" style="width: 40px; height: 32px;">
                                        <asp:ImageButton ID="ImageButton19" runat="server" ImageUrl="/images/mobile/rightarrow.png" />
                                    </td>
                                </tr>
                            </table>
                        </a>
                    ...
                    <Header>
                        <a href="" onclick="JavaScript:ShowSelection('<%= ibtnPane6.ClientID %>');" style="text-decoration: none;">
                            <table border="0" cellpadding="10" cellspacing="0" style="width: 100%;">
                                <tr>
                                    <td class="logobg" style="color: Black; height: 32px;">
                                        How do I use my Michelin MasterCard<sup>®</sup> Reward Card for making purchases?
                                    </td>
                                    <td class="logobg" style="width: 40px; height: 32px;">
                            ...
                            <tr>
                                <td>
                                    ...
                                    Reward Card, go <a href='http://www.consumercardaccess.com/tirereward' target='_blank'>
                                        online</a>, or call 1.866.614.5817 and follow the instructions on the automated
                ...
                <cc1:AccordionPane ID="AccordionPane12" runat="server" CssClass="logobg" BorderWidth="0"
                    ...
                    <Content>
                        <table border="0" cellpadding="10" cellspacing="0" style="background-color: #00445b;
                            ...
                            <tr>
                                <td>
                                    When using your Reward Card to make a purchase that is greater than the amount on
                                    the card, tell the cashier you would like to pay the difference first and then use
                                    the card to pay the remaining balance. (For example, if your total purchase is $75,
                                    you will need to pay $5 first, and then pay the remaining $70 with your MasterCard
                                    Reward Card.)
                                </td>
                            </tr>
                        </table>
                            ...
                            <tr>
                                <td>
                                    You may check your balance and transactions <a href='http://www.consumercardaccess.com/tirereward'>
                                        online</a> or by calling the automated customer service number at 1.866.614.5817
                ...
                <cc1:AccordionPane ID="AccordionPane21" runat="server" CssClass="logobg" BorderWidth="0"
                    ...
                    <Content>
                        <table border="0" cellpadding="10" cellspacing="0" style="background-color: #00445b;
                            ...
                            <tr>
                                <td>
                                    Contact 1.866.614.5817 Monday through Friday from 8:00 A.M. to 8:00 P.M. ET and
