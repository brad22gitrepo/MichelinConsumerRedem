<%@ page title="" language="VB" masterpagefile="~/MasterPage-Home.master" autoeventwireup="false" inherits="Michelin_ContactUs, App_Web_contactus.aspx.bb384c4a" %>
                    ...
                    <tr>
                                    ...
                                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding-top:10px;">
                                                <asp:DropDownList ID="ddlQuestions" Width="430px" CssClass="myListBox" runat="server">
                                        ...
                                        <tr>
                                            <td colspan="2" style="padding-bottom:10px;">
                                                <asp:TextBox ID="txtQuestionText" Width="420px" CssClass="text-box" TextMode="MultiLine" Rows="7" MaxLength="500" runat="server" /></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="text-align:right;padding-bottom:80px;padding-right:30px;">
                                                <asp:Button ID="btnSubmit" CssClass="michButton" runat="server" Height="29px" Width="119px" Text="Submit" /></td>
                                        </tr>
                                    </table>
                                    ...
                                    <td style="padding-bottom:20px;">
                                        <table style="background-color:#ededed;height:110px;" border="0" cellspacing="0" cellpadding="0" width="100%">
                                            <tr>
                                                <td style="vertical-align:middle;padding-left:15px;">
                                                    <b>Write Us</b><br />
                                                    MICHELIN<sup>®</sup> Fulfillment Center<br />
                                                    P.O. Box 289<br />
                                        ...
                                        <table style="background-color:#ededed;height:110px;" border="0" cellspacing="0" cellpadding="0" width="100%">
                                            <tr>
                                                <td style="vertical-align:middle;padding-left:15px;">
                                                    ...
                                                    <asp:HyperLink ID="lnkHaveQuestions" Target="_self" NavigateUrl="~/Michelin/FAQ.aspx" Text="Check out our FAQs" runat="server" /></td>
                                            </tr>
                                        </table></td>
                                </tr>
                            </table></td>
                        <td style="width:15%;">
                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                    <td style="padding-bottom:20px;">
                                        <asp:HyperLink ID="lnkAd1" Target="_blank" NavigateUrl="http://www.michelinman.com/" ImageUrl="~/Images/imgAdTireSelector.jpg" runat="server" /></td>
                                </tr>
                                <tr>
                                    <td style="text-align:center;">
                                        <asp:HyperLink ID="lnkAd2" Target="_blank" NavigateUrl="http://www.michelinman.com/defender" ImageUrl="~/Images/imgAd2.png" runat="server" /></td>
                                </tr>
                            </table></td>
                    </tr>
                </table></td>
