<%@ page title="" language="VB" masterpagefile="~/BFGoodrich/BFGMasterLanding.master" autoeventwireup="false" inherits="BFGoodrich_Step1, App_Web_step1.aspx.47fa3bd0" %>
                ...
                <table class="WorkingTable" border="0" cellspacing="0" cellpadding="0" width="800">
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                    ...
                                    <td class="BreadcrumbHolder">
                                        <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                            <tr>
                                                <td class="BreadcrumbOn" style="width:100%;">
                                                    Your Info</td>
                    ...
                    <tr>
                        <td style="padding-bottom:20px;padding-left:10px;padding-top:20px;">
                            Please share a little information about yourself.<br />
                            ...
                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                ...
                                <tr id="trEmailConfirm" runat="server">
                                    <td style="padding-top:20px;">
                                        ...
                                        <asp:RegularExpressionValidator ID="regEmail" ControlToValidate="txtEmail" Display="None" ErrorMessage="Invalid e-mail address format" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Runat="server" />
                                    ...
                                    <td style="width:100%;padding-top:20px;">
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtConfirmEmail" Text="The email address is not in the proper format" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" Runat="server" />
                                        ...
                                        <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender16" runat="server" TargetControlID="CompareValidator1" Width="250px" />
                                ...
                                <tr id="trEmailNote" runat="server">
                                    <td style="padding-bottom:20px;">
                                        <asp:Label ID="Label1" Font-Size="11px" Font-Italic="true" runat="server" Text="7 character minimum, case sensitive" /><br /><br />
                                        Entering your email address will allow you to check the status of your reward. We'll be communicating to you every step of 
                                        the way. BFGoodrich has a very strict privacy policy.  We do not sell or rent your personally identifiable information to 
                                        third parties.</td>
                                    <td>
                                        </td>
                                </tr>
                                ...
                                <tr>
                                    <td style="padding-top:10px;">
                                        ...
                                        <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender25" TargetControlID="RegExpValAddress" Width="250px" runat="server" />
                                    <td style="padding-top:10px;">
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender12" TargetControlID="RegExpValCity" Width="250px" runat="server" />
                                    <td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Zip Code must be at least 5 digits, no spaces allowed." SetFocusOnError="true" Display="None" ControlToValidate="txtZip" ValidationExpression="^(\d{5}-\d{4}|\d{5}|\d{9})$|^([a-zA-Z]\d[a-zA-Z] \d[a-zA-Z]\d)$" />
                    ...
                    <tr>
                        <td style="padding-top:30px;padding-bottom:30px;">
                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                <tr>
                                    <td class="grayLine">
                                        <asp:Image ID="Image2" ImageUrl="~/Images/spacer.gif" Height="1px" runat="server" /></td>
                                </tr>
                            </table></td>
                    </tr>
                    <% ' Survey Questions %>
                    <tr>
                        <td style="padding-left:20px;padding-right:20px;">
                            <asp:UpdatePanel ID="upSurvey" runat="server">
                                <ContentTemplate>
                                    <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                        <tr>
                                            <td colspan="2">
                                                <asp:DropDownList ID="ddlPromotion" runat="server" CssClass="myListBox" Width="340px" AppendDataBoundItems="true" AutoPostBack="true">
                                                    <asp:ListItem Text="*Choose Your Promotion" Value="" />
                                                </asp:DropDownList>
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="ddlPromotion" Display="None" SetFocusOnError="true" ErrorMessage="Promotion is a Required Field" />
                                                <cc1:ValidatorCalloutExtender ID="ValidatorCalloutExtender13" TargetControlID="RequiredFieldValidator13" Width="250px" runat="server" /></td>
                                        </tr>
                                        <tr id="trStaticText" runat="server">
                                            <td class="pageHeaderSubText" colspan="2" style="padding-top:20px;">
                                                Thinking of your recent tire purchase: </td>
                                        </tr>
                                        <tr>
                                            <td style="width:50%;">
                                                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                    <tr id="trHowManyTires1" runat="server">
                                                        <td style="padding-top:15px;">
                                                            <asp:Label ID="lblHowManyTires" runat="server" Text="How many tires did you intend to purchase prior to learning of this promotion?" /></td>
                                                    </tr>
                                                    <tr id="trHowManyTires2" runat="server">
                                                        <td>
                                                            <asp:DropDownList ID="ddlHowManyTires" runat="server" CssClass="myListBox" Width="50px" AppendDataBoundItems="true">
                                                                <asp:ListItem Text="" Value="-1" />
                                                            </asp:DropDownList></td>
                                                    </tr>
                                                    <tr id="trWhatTireBrand1" runat="server">
                                                        <td style="padding-top:15px;">
                                                            <asp:Label ID="lblWhatTireBrand" runat="server" Text="What tire brand was replaced when you purchased your new set of MICHELIN® tires?" /></td>
                                                    </tr>
                                                    <tr id="trWhatTireBrand2" runat="server">
                                                        <td>
                                                            <asp:DropDownList ID="ddlWhatTireBrand" runat="server" CssClass="myListBox" Width="150px" AppendDataBoundItems="true">
                                                                <asp:ListItem Text="" Value="-1" />
                                                            </asp:DropDownList></td>
                                                    </tr>
                                                    <tr id="trHowDidYouHear1" runat="server">
                                                        <td style="padding-top:15px;">
                                                            <asp:Label ID="lblHowDidYouHear" runat="server" Text="How did you first hear about this promotion?" /></td>
                                                    </tr>
                                                    <tr id="trHowDidYouHear2" runat="server">
                                                        <td>
                                                            <asp:DropDownList ID="ddlHowDidYouHear" runat="server" CssClass="myListBox" Width="250px" AppendDataBoundItems="true">
                                                                <asp:ListItem Text="" Value="-1" />
                                                            </asp:DropDownList></td>
                                                    </tr>
                                                    <tr id="trHowManyVehicles1" runat="server">
                                                        <td style="padding-top:15px;">
                                                            <asp:Label ID="lblHowManyVehicles" runat="server" Text="How many vehicles are in your household?" /></td>
                                                    </tr>
                                                    <tr id="trHowManyVehicles2" runat="server">
                                                        <td>
                                                            <asp:DropDownList ID="ddlHowManyVehicles" runat="server" CssClass="myListBox" Width="50px" AppendDataBoundItems="true">
                                                                <asp:ListItem Text="" Value="-1" />
                                                            </asp:DropDownList></td>
                                                    </tr>
                                                    <tr id="trAge1" runat="server">
                                                        <td style="padding-top:15px;">
                                                            <asp:Label ID="lblAge" runat="server" Text="What is your age?" /></td>
                                                    </tr>
                                                    ...
                                                    <tr id="trHowManyYears1" runat="server">
                                                        <td style="padding-top:15px;">
                                                            <asp:Label ID="lblHowManyYears" runat="server" Text="How many years have you been a MICHELIN® tire owner?" /></td>
                                                    </tr>
                                                    <tr id="trHowManyYears2" runat="server">
                                                        <td>
                                                            <asp:DropDownList ID="ddlHowManyYears" runat="server" CssClass="myListBox" Width="150px" AppendDataBoundItems="true">
                                                                <asp:ListItem Text="" Value="-1" />
                                                            </asp:DropDownList></td>
                                                    </tr>
                                                </table></td>
                                            <td style="width:50%;">
                                                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                    <tr id="trFactors1" runat="server">
                                                        <td style="padding-top:15px;">
                                                            <asp:Label ID="lblFactors" runat="server" Text="Which of the following was an important contributing factor in your most recent purchase of MICHELIN® tires?" /></td>
                                                    </tr>
                                                    <tr id="trFactors2" runat="server">
                                                        <td>
                                                            <asp:CheckBoxList ID="cblFactors" runat="server" /></td>
                                                    </tr>
                                                </table></td>
                                        </tr>
                                        <tr id="trStaticText2" runat="server">
                                            <td class="pageHeaderSubText" colspan="2" style="padding-top:20px;">
                                                What is the next vehicle you plan to purchase tires for? </td>
                                        </tr>
                                        <tr>
                                            <td style="width:50%;">
                                                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                    <tr id="trVehicleYear1" runat="server">
                                                        <td style="padding-top:15px;">
                                                            <asp:Label ID="lblVehicleYear" runat="server" Text="Year of Car" /></td>
                                                    </tr>
                                                    <tr id="trVehicleYear2" runat="server">
                                                        <td>
                                                            <asp:DropDownList ID="ddlVehicleYear" runat="server" CssClass="myListBox" Width="100px" AppendDataBoundItems="true" AutoPostBack="true">
                                                                <asp:ListItem Text="" Value="-1" />
                                                            </asp:DropDownList></td>
                                                    </tr>
                                                    <tr id="trVehicleMake1" runat="server">
                                                        <td style="padding-top:15px;">
                                                            <asp:Label ID="lblVehicleMake" runat="server" Text="Make" /></td>
                                                    </tr>
                                                    <tr id="trVehicleMake2" runat="server">
                                                        <td>
                                                            <asp:DropDownList ID="ddlVehicleMake" runat="server" CssClass="myListBox" Width="150px" AppendDataBoundItems="true" AutoPostBack="true">
                                                                <asp:ListItem Text="" Value="-1" Selected="True" />
                                                            </asp:DropDownList></td>
                                                    </tr>
                                                    <tr id="trVehicleModel1" runat="server">
                                                        <td style="padding-top:15px;">
                                                            <asp:Label ID="lblVehicleModel" runat="server" Text="Model" /></td>
                                                    </tr>
                                                    <tr id="trVehicleModel2" runat="server">
                                                        <td>
                                                            <asp:DropDownList ID="ddlVehicleModel" runat="server" CssClass="myListBox" Width="150px" AppendDataBoundItems="true">
                                                                <asp:ListItem Text="" Value="-1" Selected="True" />
                                                            </asp:DropDownList></td>
                                                    </tr>
                                                    <tr id="trHasMichTires1" runat="server">
                                                        <td style="padding-top:15px;">
                                                            <asp:Label ID="lblHasMichTires" runat="server" Text="Does this vehicle currently have MICHELIN® tires?" /></td>
                                                    </tr>
                                                    <tr id="trHasMichTires2" runat="server">
                                                        <td>
                                                            <asp:DropDownList ID="ddlHasMichTires" runat="server" CssClass="myListBox" Width="100px" AppendDataBoundItems="true">
                                                                <asp:ListItem Text="" Value="-1" />
                                                            </asp:DropDownList></td>
                                                    </tr>
                                                    <tr id="trExpectToPurchase1" runat="server">
                                                        <td style="padding-top:15px;">
                                                            <asp:Label ID="lblExpectToPurchase" runat="server" Text="When do you expect to purchase tires for this vehicle?" /></td>
                                                    </tr>
                                                    <tr id="trExpectToPurchase2" runat="server">
                                                        <td>
                                                            <asp:DropDownList ID="ddlExpectToPurchase" runat="server" CssClass="myListBox" Width="200px" AppendDataBoundItems="true">
                                                                <asp:ListItem Text="" Value="-1" />
                                                            </asp:DropDownList></td>
                                                    </tr>
                                                </table>
                                                ...
                                                <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                                    <tr id="trEmailOptIn" runat="server">
                                                        <td style="vertical-align:top;padding-right:3px;">
                                                            <input id="chkEmail" type="checkbox" runat="server" /></td>
                                                        <td style="width:100%;font-style:italic;">
                                                            I want email notifications so I can take advantage of valuable special offers and promotions on my 
                                                            next tire purchase, as well as sign up for new product information from BFGoodrich. BFGoodrich has a 
                                                            very strict privacy policy. We do not sell or rent your personally identifiable information to third 
                                                            parties.</td>
                                                    </tr>
                                                </table>
                                            </td>
                            ...
                            <asp:UpdateProgress ID="uprStep1" AssociatedUpdatePanelID="upSurvey" runat="server">
                                <ProgressTemplate>
                                    <GroupO:UpdateProgressLoader ID="progStep1" runat="server" />
                                </ProgressTemplate>
                            </asp:UpdateProgress></td>
                    </tr>
                    <% ' End Survey Questions %>
                    <tr>
                        <td style="text-align:right;padding-bottom:30px;padding-right:50px;padding-top:20px;">
                            <asp:ImageButton ID="btnNext" runat="server" Height="15px" AlternateText="Click here to continue" ToolTip="Click here to continue" ImageUrl="~/Images/BFGoodrich/btnNext.png" /></td>
                    </tr>
                </table></asp:Panel>
