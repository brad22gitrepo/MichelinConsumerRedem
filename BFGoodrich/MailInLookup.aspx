<%@ page title="" language="VB" masterpagefile="~/BFGoodrich/BFGMasterLanding.master" autoeventwireup="false" inherits="BFGoodrich_MailInLookup, App_Web_mailinlookup.aspx.47fa3bd0" %>
                ...
                <table class="WorkingTable" border="0" cellspacing="0" cellpadding="0" width="800">
                    <tr>
                        <td class="pageHeaderText" style="padding-bottom:0px;">
                            Thanks for mailing in your redemption!</td>
                    </tr>
                    <tr>
                        <td style="padding-bottom:30px;padding-top:15px;padding-left:15px;">
                            To locate your reward status, please tell us a little bit about yourself.<br />
                            <i>*required information</i></td>
                    </tr>
                    <tr>
                        <td style="padding-left:15px;padding-right:15px;padding-bottom:30px;">
                            <asp:Panel ID="Panel2" DefaultButton="btnContinue" runat="server">
                            <table border="0" cellspacing="0" cellpadding="0" width="100%">
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align:top;padding-left:150px;">
                                        <asp:ImageButton ID="btnContinue" runat="server" Height="15px" AlternateText="Click here to continue" ToolTip="Click here to continue" ImageUrl="~/Images/BFGoodrich/btnNext.png" /></td>
                                </tr>
                            </table></asp:Panel></td>
                    </tr>    
                </table>
